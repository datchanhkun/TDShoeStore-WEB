...
import { addToCartAction, removeFromCartAction } from "../redux/Action/cartAction";
        ...
        {/* cartiterm */}
        {
          cartItems.map((item) => (
            ...
            <div className="cart-qty col-md-2 col-sm-5 mt-md-5 mt-3 mt-md-0 d-flex flex-column justify-content-center">
              <h6>QUANTITY</h6>
              <select value={item.qty} onChange={(e) => dispatch(addToCartAction(item.product, Number(e.target.value)))}>
